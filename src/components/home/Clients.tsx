...
import { client } from "../../components/global/export";
        ...
        <div
          ...
          {client.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-white darks:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full">
